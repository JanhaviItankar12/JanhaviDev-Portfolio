...
import { registerAdmin, loginAdmin, getProtectedAdmin, logout } from "../controller/auth.js";
...
router.get("/protected", getProtectedAdmin);
...
router.post("/experience", protect,upload.single("image"), createExperience);
router.get("/experience/:id",protect, getExperienceById);
router.put("/experience/:id", protect,upload.single("image"), updateExperience);
